...
export default function Spinner({ shouldNotCover }: { shouldNotCover?: boolean }) {
	return (
		<div
			className={cn(
				"fixed inset-0 z-20 flex h-screen w-screen items-center justify-center bg-gray-500/50",
