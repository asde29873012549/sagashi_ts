...
export default function User({ user }: { user: string }) {
	...
	const { dept, chatroom_id }: { dept?: Feature; chatroom_id?: string } = router.query;
	...
	const [feature, setFeature] = useState<Feature>(dept ? dept : "My Profile");
	...
	const onMyCountryClick = () => {
		setDisplayFeature(<CountryInfo userData={userData?.data} />);
